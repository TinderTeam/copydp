		...
		<div class="user-main">
			...
			<div class="um-con">
				...
				<form name="forml" action="__URL__/search" method="post">
					<ul class="tab-filter">
						<li>
							<span>用户编号</span><input type="text" name="seller_id"/>
						</li>
						<li>
							<span>名称</span><input type="text" name="seller_name"/>
						</li>
						<li>
							<span>城市</span><input type="text" name="city_id"/>
						</li>
						<li>
							<p>分类</p>
					...
					<div class="pay-confirm">
						...
						<?php if(is_array($sellerInfo)): foreach($sellerInfo as $key=>$v1): ?><tr>
									<td valign="middle" align="left" class="deal"><?php echo ($v1["seller_id"]); ?></td>
									<td valign="middle" align="left" class="deal"><?php echo ($v1["seller_name"]); ?></td>
									<td align="center" ><?php echo ($v1["type_id"]); ?></td>
									<td align="center"> <?php echo ($v1["city_id"]); ?></td>
									<td align="center" ><?php echo ($v1["description"]); ?></td>
									<td align="center" >
...
<!-- 							<tr>
							...
							<tr >
								<td colspan="6" style=" text-align: center;" ><span><?php echo ($page); ?></span></td>
							</tr>
							</tbody>
						</table>
					</div>
