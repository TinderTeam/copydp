...
public class MispTextEditActivity extends MispHttpActivtiy
{
	...
	public void initRes()
	{
		...
		this.activityRes.setAvtivityView(MispCommonIDName.layout_misp_text_edit);
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		super.onCreate(savedInstanceState);
 		...
 		if(null != result)
		{
			takeAddr = (TextView) findViewById(MispCommonIDName.misp_text_edit_txt);
